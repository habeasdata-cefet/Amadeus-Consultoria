...
try{               
  ...
  $mail->SMTPSecure = 'tls';
  $mail->SMTPAuth   = true;
  $mail->Username   = 'contato.amadeusconsultoria@gmail.com';                     
  $mail->Password   = 'suedama2022*';
  $mail->CharSet    = 'UTF-8';
  $mail->setFrom('contato.amadeusconsultoria@gmail.com', $nome);
  ...
  if(!$mail->send()) {
    ...
    echo "<script>window.location.replace('https://amadeusconsultoria.com.br/contato.html');</script>";
  }
